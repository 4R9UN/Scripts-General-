...
maindir=os.getcwd()
def chk() :
		av_list = ['AVAST Software','AVG','Kaspersky Lab','ESET','Sophos','Microsoft Security Client','Norton Internet Security','Avira']
		...
		if var =="AVAST Software":
			...
			pth1 = "C:\Program Files\Norton Internet Security\Engine\\20.2.0.19"	
			print "\n Welcome " + var + " Cli Scan"
		elif var =="Avira":
					...
					if fileExtension_1.endswith(".exe"):
						...
						for i in range(0,end_1/block_1):
							...
							if var =="AVAST Software":
								...
								pth1 = "C:\Program Files\Kaspersky Lab\Kaspersky Internet Security 2013"
								print "\n Welcome " + var + " Cli Scan"
							elif var == "Sophos":
								pth1 = "C:\Program Files\Sophos\Sophos Anti-Virus"
								print "\n Welcome " + var + " Cli Scan"
